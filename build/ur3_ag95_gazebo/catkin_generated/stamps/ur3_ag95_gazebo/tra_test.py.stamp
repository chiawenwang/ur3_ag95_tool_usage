...
def move():
          ...
          goal.trajectory.points[1]=JointTrajectoryPoint(positions=[1.5,0,-0.2,0,0,0], velocities=[0]*6,time_from_start=rospy.Duration(1.0))
...
def pub_test():
          ...
          client = actionlib.SimpleActionClient('/ur3_controller/follow_joint_trajectory', FollowJointTrajectoryAction)
