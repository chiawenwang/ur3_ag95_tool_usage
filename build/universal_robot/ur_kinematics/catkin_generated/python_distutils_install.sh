...
echo_and_run cd "/home/gavin/robot_PKU/handwriting/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/home/gavin/robot_PKU/handwriting/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/gavin/robot_PKU/handwriting/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
